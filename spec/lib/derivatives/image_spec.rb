...
describe DulHydra::Derivatives::Image do
    ...
    context "source is a file path" do
      context "image" do
        ...
        it "should generate a thumbnail image" do
          thumbnail = DulHydra::Derivatives::Image.thumbnail(master_file_path)
      ...
      context "neither an image nor a pdf" do
        ...
        it "should raise a DulHydra::Error exception" do
          lambda { DulHydra::Derivatives::Image.thumbnail(master_file_path) }.should raise_error(DulHydra::Error)
        end
      end
    end
  end
